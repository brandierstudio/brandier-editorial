...
const PORTFOLIO_DATA = {
  ...
  projects: [
    ...
    // 04. Dior Spec (16:9)
    {
      ...
      year: "2026",
      featured: true,
      description: "High-fashion fragrance spot featuring dramatic Parisian lighting, golden bottle caustics, and photoreal crystal perfume physics.",
      youtubeId: "FNH-5yhkLZs",
      duration: "00:50",
      aspectRatio: "16/9",
      tags: ["3D Perfume", "Haute Parfumerie", "Glass Shaders", "Luxury Commercial"],
      accentColor: "#221C2B",
      caseStudy: {
